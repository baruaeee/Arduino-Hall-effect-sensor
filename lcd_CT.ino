...
void StartAuto(){
  ...
  while(key != 'S'){
    ...
    if(FileAuto){
      FileAuto.println(String(gate)+ ", "+ String(U2) + ", " + String(U3));
    }
    else {
      Serial.println("error opening Auto.txt");
      FileAuto.close();
...
void StartManual(){
  ...
  while(key != 'S'){
    ...
    if(checkButton()=='R'){
      ...
      lcd.print("U2:"+ String(U2) + "  U3:" + String(U3));
      if(FileManual){
        FileManual.println(String(gate)+ ", "+ String(U2) + ", " + String(U3));
      }
      else {
        Serial.println("error opening Manual.txt");
        FileManual.close();
